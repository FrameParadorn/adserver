        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/userlogin" class="mt-3">
                        @csrf

                        <div class="form-group row justify-content-center">

                            <div class="col-md-11">
                                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror ad-input" name="username" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="USERNAME" autocomplete="off">
