...
@section('content')
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Edit Slide #{{ $slide->id }}</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/slide/' . $slide->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
